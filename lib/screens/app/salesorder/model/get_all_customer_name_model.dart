...
//
//     final comapanyName = comapanyNameFromJson(jsonString);

import 'dart:convert';

ComapanyName comapanyNameFromJson(String str) =>
    ComapanyName.fromJson(json.decode(str));

String comapanyNameToJson(ComapanyName data) => json.encode(data.toJson());
...
class ComapanyName {
  ...
  factory ComapanyName.fromJson(Map<String, dynamic> json) => ComapanyName(
